...
struct VTBARRIER {
    ...
    enum CID cid = CID::BARRIER;
    int grfcid = 3;
    int cb = 0x5E0;
    /*undefined1* pfnInitBarrier;
    ...
    undefined1* pfnPostBarrierLoad;
    undefined1* pfnUpdateBarrier;
    ...
    undefined1* pfnFIgnoreBarrierIntersection;
    ...
    undefined1* pfnNotifyBarrierImpact;
