...
struct VTBUTTON {
    ...
    enum CID cid = CID::BUTTON;
    int grfcid = 3;
    int cb = 0x8C0;
    /*undefined1* pfnInitButton;
    ...
    undefined1* pfnCloneButton;
    undefined1* pfnLoadButtonFromBrx;
    ...
    undefined1* pfnPostButtonLoad;
    undefined1* pfnUpdateButton;
    ...
    undefined1* pfnFAbsorbButtonWkr;
    ...
    undefined1* pfnUpdateButtonInternalXps;
...
extern VTBUTTON g_vtbutton;

struct VTVOLBTN {
    struct VT* pvtSuper = g_vtso.pvtSuper;
    enum CID cid = CID::VOLBTN;
    int grfcid = 3;
    int cb = 0x7D0;
    /*undefined1* pfnInitVolbtn;
    undefined1* pfnSetLoDefaults;
    undefined1* pfnAddLo;
    undefined1* pfnRemoveLo;
    undefined1* pfnAddAloHierarchy;
