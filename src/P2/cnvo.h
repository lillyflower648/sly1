...
struct VTCNVO {
    ...
    enum CID cid = CID::CNVO;
    int grfcid = 3;
    int cb = 0x590;
    /*undefined1* pfnInitCnvo;
    ...
    undefined1* pfnAdjustCnvoXpVelocity;
