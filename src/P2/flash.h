...
struct VTFLASH {
    ...
    enum CID cid = CID::FLASH;
    int grfcid = 1;
    int cb = 0x310;
    /*undefined1* pfnInitFlash;
    ...
    undefined1* pfnLoadFlashFromBrx;
