...
extern VTIKH g_vtikh;

struct VTSCH {
    struct VT* pvtSuper = g_vtalo.pvtSuper;
    enum CID cid = CID::SCH;
    int grfcid = 1;
    int cb = 0x2E0;
...
extern VTSCH g_vtsch;

struct VTLIKH {
    struct VT* pvtSuper = g_vtalo.pvtSuper;
    enum CID cid = CID::LIKH;
    int grfcid = 1;
    int cb = 0x2E0;
    /*undefined1* pfnInitAlo;
    undefined1* pfnSetLoDefaults;
