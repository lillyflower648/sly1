...
struct VTMGV {
    ...
    enum CID cid = CID::MGV;
    int grfcid = 11;
    int cb = 0x620;
    /*undefined1* pfnInitMgv;
...
extern VTMGV g_vtmgv;

struct VTMGC {
    struct VT* pvtSuper = g_vtalo.pvtSuper;
    enum CID cid = CID::MGC;
    int grfcid = 1;
    int cb = 0x330;
    /*undefined1* pfnInitMgc;
    undefined1* pfnSetLoDefaults;
    undefined1* pfnAddLo;
    undefined1* pfnRemoveLo;
    undefined1* pfnAddAloHierarchy;
    ...
    undefined1* pfnLoadMgcFromBrx;
    undefined1* pfnAddLoRecursive;
    undefined1* pfnRemoveLoRecursive;
    undefined1* pfnHandleMgcMessage;
    undefined1* pfnSendLoMessage;
    undefined1* pfnBindAlo;
    undefined1* pfnPostMgcLoad;
    undefined1* pfnUpdateMgc;
