...
struct VTPROXY {
    ...
    enum CID cid = CID::PROXY;
    int grfcid = 257;
    int cb = 0x300;
    /*undefined1* pfnInitProxy;
    ...
    undefined1* pfnCloneProxy;
    undefined1* pfnLoadProxyFromBrx;
